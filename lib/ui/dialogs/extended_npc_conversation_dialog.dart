...
class ExtendedNpcConversationDialog extends StatefulWidget {
  ...
  @override
  State<ExtendedNpcConversationDialog> createState() =>
      _ExtendedNpcConversationDialogState();
}

class _ExtendedNpcConversationDialogState
    extends State<ExtendedNpcConversationDialog> {
  ...
  static const Color _companionColor =
      JuiceTheme.success; // Green for companion responses
  static const Color _topicColor =
      JuiceTheme.juiceOrange; // Orange for dialog topics
  ...
  Widget _buildSkewChip(
      String label, SkewType type, IconData icon, Color color) {
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Icon(icon,
                size: 14, color: isSelected ? color : Colors.grey.shade500),
    ...
    return OracleDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          // ═══════════════════════════════════════════════════════════════
          _buildSectionHeader('Companion Response', Icons.groups,
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  runSpacing: 6,
                  children: [
                    _buildSkewChip('None', SkewType.none, Icons.horizontal_rule,
                        JuiceTheme.parchmentDark),
                    _buildSkewChip('@- Opposed', SkewType.disadvantage,
                        Icons.thumb_down_outlined, _opposedColor),
                    _buildSkewChip('@+ In Favor', SkewType.advantage,
                        Icons.thumb_up_outlined, _favorColor),
                  ],
                ),
              ],
            ),
          ...
          _buildRollButton(
            ...
            color: _companionColor,
            onTap: () {
              widget.onRoll(widget.extendedNpcConversation
                  .rollCompanionResponse(skew: _companionSkew));
              Navigator.pop(context);
            },
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                _buildFavorLevelRow(
                    '1-20', 'Strongly Opposed', JuiceTheme.danger),
                _buildFavorLevelRow(
                    '21-40', 'Hesitant', JuiceTheme.juiceOrange),
                _buildFavorLevelRow(
                    '41-60', 'Neutral / Questioning', JuiceTheme.parchmentDark),
                _buildFavorLevelRow(
                    '61-80', 'Cautious Support', JuiceTheme.info),
                _buildFavorLevelRow(
                    '81-100', 'Strongly In Favor', JuiceTheme.success),
              ],
            ),
          ),
            ...
            child: Row(
              children: [
                Icon(Icons.lightbulb_outline,
                    size: 16, color: JuiceTheme.mystic),
                const SizedBox(width: 8),
                Expanded(
                  child: Text(
