...
class _TreasureDialogState extends State<TreasureDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final skewLabel = _skew == SkewType.advantage
        ? ' @+'
        : _skew == SkewType.disadvantage
            ? ' @-'
            : '';
              ...
              children: [
                SizedBox(
                  ...
                  child: Checkbox(
                    value: _includeColor,
                    onChanged: (v) =>
                        setState(() => _includeColor = v ?? false),
            ...
            children: [
              ...
              Expanded(
                child: _TreasureCategoryCard(
                  ...
                  onTap: () {
                    widget
                        .onRoll(widget.treasure.generateTreasure(skew: _skew));
                    Navigator.pop(context);
                  },
                ),
              ),
            ...
            children: [
              Expanded(
                child: _TreasureCategoryCard(
                  ...
                  onTap: () {
                    widget
                        .onRoll(widget.treasure.generateDocument(skew: _skew));
                    Navigator.pop(context);
                  },
                ),
              ),
              ...
              Expanded(
                child: _TreasureCategoryCard(
                  ...
                  onTap: () {
                    widget
                        .onRoll(widget.treasure.generateAccessory(skew: _skew));
                    Navigator.pop(context);
                  },
                ),
              ),
          ...
          Row(
            children: [
              Icon(Icons.lightbulb_outline,
                  size: 16, color: JuiceTheme.juiceOrange),
              const SizedBox(width: 6),
              Text(
                'Examples',
                style: TextStyle(
