...
class _NpcActionDialogState extends State<NpcActionDialog> {
  ...
  String _getActionDieLabel() =>
      _disposition == NpcDisposition.passive ? 'd6' : 'd10';
  String _getActionSkewLabel() => _context == NpcContext.active ? '@+' : '@-';
  String _getCombatDieLabel() => _focus == NpcFocus.passive ? 'd6' : 'd10';
  String _getCombatSkewLabel() =>
      _objective == NpcObjective.offensive ? '@+' : '@-';
      ...
      content: Column(
        ...
        children: [
                ...
                Wrap(
                  ...
                  children: [
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _needSkew = NeedSkew.none),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _needSkew == NeedSkew.none
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _needSkew = NeedSkew.primitive),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _needSkew == NeedSkew.primitive
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _needSkew = NeedSkew.complex),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _needSkew == NeedSkew.complex
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
          ...
          DialogOption(
            ...
            subtitle:
                '2 Personalities + Need${_getNeedSkewLabel()} + Motive + Color + Properties',
            onTap: () {
              widget.onRoll(
                  widget.npcAction.generateProfile(needSkew: _needSkew));
              Navigator.pop(context);
            },
          ),
          const Divider(),
          ...
          DialogOption(
            ...
            subtitle:
                '2d10 - "Primary, yet Secondary" (e.g., "Confident, yet Reserved")',
            onTap: () {
          ...
          const SectionHeader(
              title: 'Action Table', icon: Icons.directions_run),
          const SizedBox(height: 4),
          Container(
            padding: const EdgeInsets.all(6),
            decoration: BoxDecoration(
                ...
                Row(
                  children: [
                    ...
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _disposition = NpcDisposition.passive),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _disposition == NpcDisposition.passive
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
                    ...
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _disposition = NpcDisposition.active),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _disposition == NpcDisposition.active
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
                ...
                Row(
                  children: [
                    ...
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _context = NpcContext.passive),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _context == NpcContext.passive
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
                    ...
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _context = NpcContext.active),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _context == NpcContext.active
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
          ...
          DialogOption(
            title: 'Roll Action',
            subtitle:
                '${_getActionDieLabel()}${_getActionSkewLabel()} - ${_disposition.name} / ${_context.name}',
            onTap: () {
          ...
          const SectionHeader(
              title: 'Combat Table', icon: Icons.sports_kabaddi),
          const SizedBox(height: 4),
          Container(
            padding: const EdgeInsets.all(6),
            decoration: BoxDecoration(
                ...
                Row(
                  children: [
                    ...
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _focus = NpcFocus.passive),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _focus == NpcFocus.passive
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
                    ...
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _focus = NpcFocus.active),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _focus == NpcFocus.active
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
                ...
                Row(
                  children: [
                    ...
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _objective = NpcObjective.defensive),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _objective == NpcObjective.defensive
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
                    ...
                    ChoiceChip(
                      ...
                      onSelected: (s) =>
                          setState(() => _objective = NpcObjective.offensive),
                      visualDensity: VisualDensity.compact,
                      labelStyle: TextStyle(
                        color: _objective == NpcObjective.offensive
                            ? JuiceTheme.background // dark text when selected
                            : null, // falls back to theme default when unselected
                      ),
                    ),
          ...
          DialogOption(
            title: 'Roll Combat',
            subtitle:
                '${_getCombatDieLabel()}${_getCombatSkewLabel()} - ${_focus.name} / ${_objective.name}',
            onTap: () {
