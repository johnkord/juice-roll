...
class _DialogGeneratorDialogState extends State<DialogGeneratorDialog> {
      ...
      children: [
        ...
        for (int row = 0; row < 5; row++)
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              for (int col = 0; col < 5; col++) _buildGridCell(row, col),
            ],
          ),
      ],
    );
  ...
  Widget _buildToneLegendChip(
      String tone, String direction, String range, Color color) {
    return Container(
      ...
      content: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isActive ? JuiceTheme.success10 : JuiceTheme.juiceOrange10,
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: dialogColor.withOpacity(0.15),
                        borderRadius: BorderRadius.circular(4),
                      ),
                      child: Text(
                        currentFragment,
                        style: TextStyle(
                          ...
                          fontFamily: JuiceTheme.fontFamilySerif,
                          fontStyle:
                              isPast ? FontStyle.italic : FontStyle.normal,
                          color: dialogColor,
                        ),
                      ),
                    ),
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          fontStyle:
                              isPast ? FontStyle.italic : FontStyle.normal,
                          color:
                              isPast ? JuiceTheme.sepia : Colors.grey.shade400,
                        ),
                      ),
                    ),
                  ],
                ),
                if (DialogGenerator.fragmentDescriptions[currentFragment] !=
                    null) ...[
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  runSpacing: 4,
                  children: [
                    _buildToneLegendChip(
                        'Neutral', '↑', '1-2', JuiceTheme.info),
                    _buildToneLegendChip(
                        'Defensive', '←', '3-5', JuiceTheme.rust),
                    _buildToneLegendChip(
                        'Aggressive', '→', '6-8', JuiceTheme.danger),
                    _buildToneLegendChip(
                        'Helpful', '↓', '9-0', JuiceTheme.success),
                  ],
                ),
