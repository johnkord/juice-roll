  ...
  Widget _buildGridCell(int row, int col, {bool isHighlighted = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            isHighlighted ? _iconColor.withOpacity(0.4) : JuiceTheme.inkDark60,
        borderRadius: BorderRadius.circular(3),
        border: Border.all(
          color: isHighlighted ? _iconColor : JuiceTheme.parchmentDark30,
          width: isHighlighted ? 1.5 : 0.5,
        ),
      ),
      child:
          isHighlighted ? Icon(Icons.image, size: 12, color: _iconColor) : null,
    );
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                _buildUseCase(Icons.swap_horiz,
                    'Alternative to word-based meaning tables'),
                _buildUseCase(Icons.visibility,
                    'Visual inspiration for scenes or encounters'),
                _buildUseCase(Icons.psychology,
                    'Interpret the symbol in your current context'),
                _buildUseCase(
                    Icons.layers, 'Use multiple icons for complex situations'),
              ],
            ),
          ),
          const SizedBox(height: 14),
