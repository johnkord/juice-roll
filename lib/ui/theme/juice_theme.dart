...
class JuiceTheme {
  ...
  static const Color gold = Color(0xFFc7a34f);

  /// Sepia brown - for secondary accents
  static const Color sepia = Color(0xFFa2907b);

  /// Worn leather/rust accent
  static const Color rust = Color(0xFFbf8b6c);

  /// Juice brand orange (from logo)
  static const Color juiceOrange = Color(0xFFFF6B35);

  /// Muted red for danger/warnings
  static const Color danger = Color(0xFFff5c5b);

  /// Muted green for success/positive
  static const Color success = Color(0xFF58af5b);

  /// Muted blue for information
  static const Color info = Color(0xFF6f9fd6);

  /// Muted purple for mystical elements
  static const Color mystic = Color(0xFFaa8cca);

  // ═══════════════════════════════════════════════════════════════════════════
  // CACHED OPACITY COLORS
  // ═══════════════════════════════════════════════════════════════════════════
  //
  // Pre-computed colors with opacity to avoid creating new Color objects
  // on every build. Use these instead of calling .withOpacity() directly.
  //
  // Naming convention: {colorName}{opacity percentage}
  // Example: parchmentDark60 = parchmentDark.withOpacity(0.6)
  //
  // When to add new cached colors:
  // 1. Run: grep -rohE 'JuiceTheme\.[a-zA-Z]+\.withOpacity\([0-9.]+\)' lib/ui/ | sort | uniq -c | sort -rn
  // 2. Add colors that appear 3+ times
  // ═══════════════════════════════════════════════════════════════════════════

  // Ink variants (dark backgrounds)
  static final Color ink30 = ink.withOpacity(0.3);
  static final Color ink20 = ink.withOpacity(0.2);
  ...
  static final Color parchmentDark70 = parchmentDark.withOpacity(0.7);
  static final Color parchmentDark60 = parchmentDark.withOpacity(0.6);
  static final Color parchmentDark50 = parchmentDark.withOpacity(0.5);
  static final Color parchmentDark40 = parchmentDark.withOpacity(0.4);
  static final Color parchmentDark35 = parchmentDark.withOpacity(0.35);
  ...
  static const Color categoryWorld = Color(0xFFc3a454);

  /// Character/NPC - warm tan
  static const Color categoryCharacter = Color(0xFFB8A07A);

  /// Combat/Challenge - rust-touched
  static const Color categoryCombat = Color(0xFFc7866c);

  /// Exploration - forest brown-green
  static const Color categoryExplore = Color(0xFF86a36b);

  /// Utility - muted gray-brown
  static const Color categoryUtility = Color(0xFF98897f);
  ...
  static BoxDecoration dialogOptionDecoration(Color accentColor) =>
      BoxDecoration(
        color: accentColor.withOpacity(0.08),
        borderRadius: BorderRadius.circular(8),
  ...
  static ThemeData get themeData => ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          hintStyle: TextStyle(color: parchmentDark.withOpacity(0.8)),
        ),
