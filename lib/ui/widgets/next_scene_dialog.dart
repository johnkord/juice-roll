      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _useSimpleMode
                  ? JuiceTheme.juiceOrange.withValues(alpha: 0.4)
                  : JuiceTheme.parchmentDark.withValues(alpha: 0.2),
            ),
          ),
          child: Row(
            children: [
            ...
            child: Row(
              children: [
                ...
                Icon(
                  Icons.chevron_right,
                  size: 18,
                  color: (highlighted ? iconColor : JuiceTheme.gold).withValues(alpha: 0.6),
                ),
              ],
            ),
          ),
