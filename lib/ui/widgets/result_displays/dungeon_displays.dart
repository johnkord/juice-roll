...
void registerDungeonDisplays() {
  ResultDisplayRegistry.register<DungeonEncounterResult>(
      _buildDungeonEncounterDisplay);
  ...
  ResultDisplayRegistry.register<FullDungeonAreaResult>(
      _buildFullDungeonAreaDisplay);
  ResultDisplayRegistry.register<TwoPassAreaResult>(_buildTwoPassAreaDisplay);
  ResultDisplayRegistry.register<DungeonMonsterResult>(
      _buildDungeonMonsterDisplay);
  ResultDisplayRegistry.register<DungeonTrapResult>(_buildDungeonTrapDisplay);
  ResultDisplayRegistry.register<TrapProcedureResult>(
      _buildTrapProcedureDisplay);
  ResultDisplayRegistry.register<DungeonDetailResult>(
      _buildDungeonDetailDisplay);
}
...
Widget _buildDungeonEncounterDisplay(
    DungeonEncounterResult result, ThemeData theme) {
  return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    Container(
      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
      decoration: BoxDecoration(
          color: JuiceTheme.rust10, borderRadius: BorderRadius.circular(8)),
      child: Text('Encounter: ${result.encounterRoll.result}',
          style: TextStyle(
    ...
    if (result.monster != null) ...[
      ...
      Text('Monster: ${result.monster!.monsterDescription}',
          style: theme.textTheme.bodyMedium),
    ],
    if (result.trap != null) ...[
      const SizedBox(height: 4),
      Text('Trap: ${result.trap!.trapDescription}',
          style: theme.textTheme.bodyMedium),
    ],
  ]);
}
  ...
  return Row(children: [
    Container(
      ...
      decoration: BoxDecoration(
          color: JuiceTheme.rust10, borderRadius: BorderRadius.circular(8)),
      child: Text(
          '3d10: [${result.typeRoll}, ${result.descriptionRoll}, ${result.subjectRoll}]',
          style: TextStyle(
              fontFamily: JuiceTheme.fontFamilyMono,
              fontWeight: FontWeight.bold,
              color: JuiceTheme.rust)),
...
Widget _buildDungeonAreaDisplay(DungeonAreaResult result, ThemeData theme) {
  final phaseColor = result.phase == DungeonPhase.entering
      ? JuiceTheme.gold
      : JuiceTheme.success;
  ...
  return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    ...
    if (result.passage != null) ...[
      const SizedBox(height: 4),
      Text('Passage: ${result.passage!.result}',
...
Widget _buildFullDungeonAreaDisplay(
    FullDungeonAreaResult result, ThemeData theme) {
  return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    _buildDungeonAreaDisplay(result.area, theme),
    const SizedBox(height: 6),
    Text('Condition: ${result.condition.result}',
        style:
  ...
  return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(4),
          border: Border.all(color: JuiceTheme.rust50)),
      child: Text('${result.roll1},${result.roll2} → ${result.chosenRoll}',
          style: TextStyle(
              fontWeight: FontWeight.bold,
              color: JuiceTheme.rust,
              fontFamily: JuiceTheme.fontFamilyMono,
    ...
    if (result.isSecondDoubles)
      Container(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
        decoration: BoxDecoration(
            color: JuiceTheme.gold20, borderRadius: BorderRadius.circular(4)),
        child: Text('⚡ Secret/Treasure!',
            style: TextStyle(
                fontWeight: FontWeight.bold,
...
Widget _buildDungeonMonsterDisplay(
    DungeonMonsterResult result, ThemeData theme) {
  return Row(children: [
    Container(
      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
      decoration: BoxDecoration(
          color: JuiceTheme.danger10, borderRadius: BorderRadius.circular(8)),
      child: Text('2d10: [${result.descriptorRoll}, ${result.abilityRoll}]',
          style: TextStyle(
              fontFamily: JuiceTheme.fontFamilyMono, color: JuiceTheme.danger)),
    ),
    const SizedBox(width: 8),
    Expanded(
        child: Text(result.monsterDescription,
            style: theme.textTheme.bodyMedium
...
Widget _buildDungeonTrapDisplay(DungeonTrapResult result, ThemeData theme) {
  return Row(children: [
    Container(
      ...
      child: Text('2d10: [${result.actionRoll}, ${result.subjectRoll}]',
          style: TextStyle(
              fontFamily: JuiceTheme.fontFamilyMono, color: Colors.orange)),
    ),
    const SizedBox(width: 8),
    Expanded(
        child: Text(result.trapDescription,
            style: theme.textTheme.bodyMedium
                ?.copyWith(fontWeight: FontWeight.bold))),
  ]);
}
...
Widget _buildDungeonDetailDisplay(DungeonDetailResult result, ThemeData theme) {
  return Row(children: [
    Container(
      ...
      decoration: BoxDecoration(
          color: JuiceTheme.rust10, borderRadius: BorderRadius.circular(8)),
      child: Text('d10: ${result.roll}',
          style: TextStyle(
              fontFamily: JuiceTheme.fontFamilyMono, color: JuiceTheme.rust)),
    ),
    const SizedBox(width: 8),
    Expanded(
